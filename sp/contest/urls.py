...
urlpatterns = patterns('',
    ...
    url(r'^(\d+)/list/article/(\d+)/$', 'sp.contest.views.list', name='contest_article'),
    ...
    url(r'^add/ajax/$', 'sp.contest.views.contest_add_ajax', name='contest_add'),
    url(r'^work/(\d+)/$', 'sp.contest.views.contest_work', name='contest_work'),
    url(r'^done/$', TemplateView.as_view(template_name='contest/contest_done.html'), name='contest_done'),
